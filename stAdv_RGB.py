...
# Define placeholders
images = tf.compat.v1.placeholder(tf.float32, shape=[None, IMG_HEIGHT, IMG_WIDTH, CHANNELS], name='images')
flows = tf.compat.v1.placeholder(tf.float32, shape=[None, 2, IMG_HEIGHT, IMG_WIDTH], name='flows')
...
results = stadv.optimization.lbfgs(
    ...
    flows_x0=np.random.random_sample((1, 2, 32, 32)),
